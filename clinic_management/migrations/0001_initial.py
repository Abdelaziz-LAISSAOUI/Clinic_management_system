# Generated by Django 5.0 on 2024-01-28 22:53
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Appointment',
            fields=[
                ('patient', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='appointments', serialize=False, to='clinic_management.patient')),
                ('confirmation', models.BooleanField(default=False)),
                ('cancelation', models.BooleanField(default=False)),
                ('date', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='appointments', to='clinic_management.tdate')),
                ('doctor', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='appointments', to='clinic_management.doctor')),
            ],
        ),
    ]
